...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'tickets.context_processors.ticket_notifications_processor',
            ],
        },
    },
]
...
EMAIL_HOST_USER = os.getenv('EMAIL_HOST_USER', 'helpdesk@siet.edu.in')
EMAIL_HOST_PASSWORD = os.getenv('EMAIL_HOST_PASSWORD', '')
DEFAULT_FROM_EMAIL = os.getenv('DEFAULT_FROM_EMAIL', 'SIET Helpdesk <helpdesk@siet.edu.in>')
